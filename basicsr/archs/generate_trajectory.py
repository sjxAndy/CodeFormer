...
if __name__ == '__main__':
    trajectory = Trajectory(canvas=19, expl=0.005, path_to_save='tmp/trajectory.png')
    x = trajectory.fit(False, True).x
    print(x)
    print(x.real)
    print(x.imag)
    print(max(x.real), min(x.real), max(x.imag), min(x.imag))
